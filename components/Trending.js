...
export default function Trending() {
  return (
    <div className="hidden lg:flex flex-col mt-4 mx-7">
      ...
      <div className="w-[300px] h-[500px] bg-white bg-opacity-10 rounded-3xl mt-3">
        ...
        <div className="relative p-3">
          <DotsHorizontalIcon className="w-5 text-gray-500 absolute right-4" />
          <p className="text-xs text-gray-500">Trending in US</p>
          <h1 className="text-[15px] font-bold">CryptoCurrency</h1>
        ...
        <div className="relative p-3">
          ...
          <p className="text-xs text-gray-500">225K Tweets</p>
        </div>
        <div className="relative p-3">
          <DotsHorizontalIcon className="w-5 text-gray-500 absolute right-4" />
          <p className="text-xs text-gray-500">Trending in US</p>
      ...
      <div className="w-[300px] h-[300px] bg-white bg-opacity-10 rounded-3xl mt-3">
        ...
        <div className="flex justify-between p-3">
          <div className="flex space-x-3">
            ...
            <div>
              <div className="flex space-x-1">
                <h1 className="font-bold">Rihanna</h1>
                <BadgeCheckIcon className="w-[18px] text-blue-400" />
              </div>
              <h1 className="text-[12px] mt-1 text-gray-500">@rihanna</h1>
            </div>
          </div>
          <button className="bg-white text-black text-sm w-20 h-8 rounded-3xl font-bold cursor-not-allowed">
            Follow
        ...
        <div className="flex justify-between p-3">
          <div className="flex space-x-3">
            ...
            <div>
              <div className="flex space-x-1">
                <h1 className="font-bold">Cristiano</h1>
                <BadgeCheckIcon className="w-[18px] text-blue-400" />
              </div>
              <h1 className="text-[12px] mt-1 text-gray-500">@cristiano</h1>
            </div>
          </div>
          <button className="bg-white text-black text-sm w-20 h-8 rounded-3xl font-bold cursor-not-allowed">
            Follow
