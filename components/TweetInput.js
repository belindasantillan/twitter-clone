  ...
  return (
    <div className="flex space-x-3 p-3 border-b border-gray-700">
      <img
        ...
        src={user.photoUrl || "/assets/twitter.jpg" }
      />
        ...
        {image && (
          <div className="relative mb-4">
            <div
              ...
              className="absolute top-1 left-1 w-8 h-8 rounded-full bg-[#272c26]
              flex justify-center items-center cursor-pointer hover:bg-gray hover:bg-opacity-40"
            >
              <XIcon className="h-5" />
            </div>
